...
const CASES = [
  ...
  { name: "packaging + shipping + discount + gst",
    inv: { tax_mode: "gst", tax_rate: 18, discount_pct: 10, shipping: 50, packaging: 30 },
    items: [{ qty: 2, rate: 499 }] },
  { name: "packaging alone, no tax",
    inv: { tax_mode: "none", packaging: 25.5 },
    items: [{ qty: 1, rate: 74.5 }] },
  { name: "round off on",
